...
- **파이어 구체적 설명**:
  ...
  - **룸**:
	...
	- 룸은 기본적으로 일반 피드와 일반 채팅이라는 스페이스를 포함합니다. 이는 삭제할 수 없습니다.
        - 룸에 가입할 때 초대장을 통한 가입은 사용자자 역할을 부여받고, 공개 룸의 가입은 게스트의 역할을 부여받습니다.
        - 룸에서 부여된 역할에 따라 사용할 수 있는 스페이스가 달라질 수 있습니다.
        - 룸 역할: 어드민, 관리자(모더), 사용자, 게스트 순서로 권한이 낮아집니다.
        - 관리자 역할부터 룸을 관리할 수 있으며, 자신과 동일하거나 높은 역할의 멤버는 차단 및 역할 변경을 할 수 없습니다.
  ...
  - **스페이스**:
	...
	- 스페이스는 개별로 권한을 부여할 수 있습니다. 해당 스페이스가 가진 권한보다 높은 권한을 가진 멤버만 스페이스가 룸에 표시됩니다.
          - 게스트 권한을 가진 멤버일 경우 사용자 권한의 스페이스를 사용할 수 없습니다. 
	- 피드 스페이스의 경우 권한이 있는 사용자가 피드를 업로드할 수 있고, 채팅 스페이스의 경우 권한이 있는 사용자가 채팅을 할 수 있습니다(채팅 구현 중..)
...
### 룸 메인 페이지
![image](https://github.com/Pyre-org/.github/assets/39799541/8df01662-3412-4e41-a525-1ae66ea11fee)
...
### 룸 멤버 역할 관리
![룸 멤버 역할 변경](https://github.com/Pyre-org/.github/assets/39799541/9531d54e-c9f9-4032-a4a8-0c33aa819412)
